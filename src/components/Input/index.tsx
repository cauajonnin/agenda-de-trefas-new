...
export const Input = forwardRef((props: Props, ref: LegacyRef<TextInput> | null) => {
    const { IconLeft, IconRigth, iconLeftName, iconRightName, title, onIconLeftPress, onIconRigthPress, height,labelStyle,error,errorMessage,...rest } = props;
    ...
    return (
        <>
            ...
            {error && errorMessage && (
                <Text style={{ color: '#ff0000', fontSize: 12, marginTop: 5 }}>{errorMessage}</Text>
            )}
        </>
    );
});
